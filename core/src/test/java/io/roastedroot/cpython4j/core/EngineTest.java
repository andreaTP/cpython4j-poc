...
public class EngineTest {
    ...
    //                engine,
    //                String.format(
    //                        "from_java.myFunc(%d, \"%s\", %d);", expectedX, expectedY,
    // expectedZ));
    //    }
    //
    ...
    //                                            assertEquals("invalid_type",
    // res.error.issues[0].code);
    //                                            assertEquals("number",
    // res.error.issues[0].received);
    //                                            assertEquals("string",
    // res.error.issues[0].expected);
    //
    //                                            return null;
    //                                        }))
    //                        .build();
    ...
    //
    //        var jsSource =
    // EngineTest.class.getResourceAsStream("/zod/dist/out.js").readAllBytes();
    //
    ...
    //                                // this code needs to be generated based on @GuestFunction
    // generated
    //                                // code
    ...
    //        var userCodePtr = engine.compile("java_api.setResult(jsFunctions.calculator.add(1,
    // 2));");
    ...
    //                        .add(
    //                                new GuestFunction(
    //                                        "testCompatibility", List.of(String.class),
    // JsonNode.class))
    //                        .build();
    //
    //        var engine = Engine.builder().addBuiltins(builtins).addInvokables(invokables).build();
    ...
    //                        .add(
    //                                new GuestFunction(
    //                                        "validateString", List.of(String.class),
    // ZodResult.class))
    //                        .build();
